  ...
  <div class="section">
    <div class="slide red-section">
      <div class="wrap">
        <h4>背景</h4>
        <p class="content">
          成钞公司质量管理系统从2014年开始开发，伴随着公司对质量管理要求的不断提升而逐步完善，主要解决了公司在生产质量管理过程中遇到的四类问题：
        </p>
        <ol class="text-left">
          <li>联结系统之间的数据孤岛。</li>
          <li>快速的数据统计和分析，让管理人员能将更多精力专注于问题分析。</li>
          <li>信息及时传递与有效沟通。</li>
          <li>用大数据指导质量管理。</li>
        </ol>
      </div>
    ...
    <v-chart :option="option.infoIsland" :fill="'#313640'" />
